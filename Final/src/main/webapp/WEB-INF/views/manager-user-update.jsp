...
<nav class="navbar navbar-fixed-top navbar-inverse">
	...
	<div class="container">
		<form:form class="form-signin" action="${contextPath}/user/managerupdate"
			commandName="user" method="post">
			<h2 class="form-signin-heading">Please Register a New Account</h2>

			<div class="form-group">
				<label for="exampleInputEmail1">User ID</label>
				<form:input type="text" path="personID" class="form-control"
					value="${user.personID}" name="personID" required="required"
					readonly="true" />
			...
			<div class="form-group">
				...
				<form:input type="text" path="firstName" class="form-control"
					value="${user.firstName}" name="firstName" required="required" />
				<font color="red"><form:errors path="firstName" /></font>
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">Last Name</label>
				<form:input type="text" path="lastName" class="form-control"
					value="${user.lastName}" name="lastName" required="required" />
			...
			<div class="form-group">
				...
				<form:input type="email" path="email.emailAddress"
					class="form-control" name="email.emailAddress"
					value="${user.email.emailAddress}" placeholder="Email"
					required="required" />
			...
			<div class="form-group">
				...
				<form:input type="text" path="type" class="form-control" name="type"
					value="${user.type}" placeholder="type" required="required"
					readonly="true" />
