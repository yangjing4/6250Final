	...
	<h2 class="form-signin-heading">Please Register a New Account</h2>
		...
		<div class="form-group">
			<label for="exampleInputEmail1">First Name</label>
			 <form:input type="text" path="firstName" class="form-control" name="firstName" required="required" />
			 <font color="red"><form:errors path="firstName" /></font>	
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">Last Name</label>
			 <form:input type="text" path="lastName" class="form-control" name="lastName" required="required"/>
			 <font color="red"><form:errors path="lastName" /></font>	
		</div>
		<div class="form-group">
			<label for="exampleInputEmail1">User Name</label>
			 <form:input type="text" path="username" class="form-control" name="username" required="required"/>
	  ...
	  <div class="form-group">
		    ...
		    <form:input type="email" path="email.emailAddress" class="form-control" name="email.emailAddress"  placeholder="Email" required="required"/>
